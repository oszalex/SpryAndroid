...
@interface BroModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation BroModelController
...
{   
    ...
    BroDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"BroDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(BroDataViewController *)viewController];
