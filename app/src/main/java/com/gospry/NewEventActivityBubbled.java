...
public class NewEventActivityBubbled extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_event_bubbled);
        newevent = new Event();
    }
    ...
    private void startNext() {
        ...
        intent.setClass(NewEventActivityBubbled.this, AddFriendsActivity.class);
    ...
    public void createEvent(View view) {
        ...
        state.setCallback(new RemoteCallback() {
            ...
            public void onRequestOk(RemoteResponse response) {
                ...
                Toast.makeText(NewEventActivityBubbled.this, "Event created: " + response.getString() + "Activity: " + this.toString(), Toast.LENGTH_LONG).show();
            ...
            public void onRequestFailed(RemoteResponse response) {
                Toast.makeText(NewEventActivityBubbled.this, "Could not create event: " + response.getString(), Toast.LENGTH_LONG).show();
                finish();
            }
        });
